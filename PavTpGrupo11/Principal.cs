...
namespace PavTpGrupo11
{
    public partial class Principal : Form
    {
        ...
        private void listadoObraToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ReporteListadoObras ventana = new ReporteListadoObras();
            ventana.ShowDialog();
        }

        private void obrasPorBarrioToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ReporteEstadisticaObrasXBarrio ventana = new ReporteEstadisticaObrasXBarrio();
            ventana.ShowDialog();

        }

        private void listadoCamionesToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            ReporteEstadisticaCamionesXMarca ventana = new ReporteEstadisticaCamionesXMarca();
            ventana.ShowDialog();
        }
    }
}
