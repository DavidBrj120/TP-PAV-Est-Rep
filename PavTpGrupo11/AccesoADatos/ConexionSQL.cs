   ...
   public  class ConexionSQL
    {
        ...
        public static DataTable ObtenerObraxCod(int cod)
        {
            try
            {
                ...
                string consulta = "SELECT * FROM Obras WHERE codigo_obra = '" + cod + "'";
        ...
        public static DataTable ObtenerObraxIdBarrio(int id)
        {
            try
            {
                ...
                string consulta = "SELECT * FROM Obras WHERE id_barrio = '" + id + "'";
        ...
        public static DataTable ObtenerEstadisticasObrasXbarrio()
        {
            try
            {
                ...
                string consulta = "Select v.nombre_barrio,COUNT(de.id_barrio) as Cantidad FROM obras de Inner join Barrios v On de.id_barrio = v.id_barrio Group by v.nombre_barrio";
        ...
        public static DataTable ObtenerCamionesXPatente(string pat)
        {
            try
            {
                SqlCommand cmd = new SqlCommand();

                string consulta = "SELECT * FROM Camiones WHERE Patente = '" + pat + "'";
        ...
        public static DataTable ObtenerCamionesXMarca(string marca)
        {
            try
            {
                SqlCommand cmd = new SqlCommand();

                string consulta = "SELECT * FROM Camiones WHERE Marca_Camión = '" + marca + "'";
        ...
        public static DataTable ObtenerEstadisticasCamionesXMarca()
        {
            try
            {
                SqlCommand cmd = new SqlCommand();

                string consulta = "Select v.Marca_Camión,COUNT(de.Patente) as Cantidad FROM [BD3K3G11_2022].[dbo].[Camiones] de Inner join Camiones v On de.Patente = v.Patente Group by v.Marca_Camión\r\n";
